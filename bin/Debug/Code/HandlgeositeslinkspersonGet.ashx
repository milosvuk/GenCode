<%@ WebHandler Language="C#" Class="HandlgeositeslinkspersonGet" %>
using System;
...
public class HandlgeositeslinkspersonGet : IHttpHandler {
    public void ProcessRequest (HttpContext context) {
        ...
        //callgetMethod
        DB_geositeslinksperson _db = new DB_geositeslinksperson();
        List<geositeslinksperson> listitems = new List<geositeslinksperson>();
