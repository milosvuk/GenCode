<%@ WebHandler Language="C#" Class="HandlservicesGet" %>
using System;
...
public class HandlservicesGet : IHttpHandler {
    public void ProcessRequest (HttpContext context) {
        ...
        //callgetMethod
        DB_services _db = new DB_services();
        List<services> listitems = new List<services>();
