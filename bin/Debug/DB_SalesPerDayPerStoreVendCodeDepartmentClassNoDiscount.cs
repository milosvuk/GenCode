...
public class DB_SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount
 
{
public string connString;
public string connectionString;
public DB_SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount()
{
...
public int Add(SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount _tmpObject)
{
...
public int Add(SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
SqlCommand command = new SqlCommand("INSERT INTO SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount (Store_no,Vendor_code,Department,Class_,DateOfSales,CalendarWeek,Month,Year,TotalSales,TotalSalesQtyUnitsSold,TotalMargin,TotalMarkDown,TypeOfSale) VALUES (@Store_no,@Vendor_code,@Department,@Class_,@DateOfSales,@CalendarWeek,@Month,@Year,@TotalSales,@TotalSalesQtyUnitsSold,@TotalMargin,@TotalMarkDown,@TypeOfSale) SET @tmpid = SCOPE_IDENTITY()", conn);
if (tran != null)
{
...
public int Update(SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount _tmpObject)
{
...
public int Delete(SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount _tmpObject)
{
...
public int Delete(SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
SqlCommand command = new SqlCommand("DELETE SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount  WHERE id=@id", conn);
if (tran != null)
{
command.Transaction = tran;
}
...
//GET BY ID ---------------------------------------------
////==========================================================================
public SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount GetById(int _id)
{
SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount tmpObject = new SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount();
  
 
 
SqlConnection conn = new SqlConnection(connectionString); 
SqlCommand command = new SqlCommand("Select * From SalesPerDayPerStoreVendCodeDepartmentClassNoDiscount WHERE id=" + _id.ToString(), conn);
conn.Open();
