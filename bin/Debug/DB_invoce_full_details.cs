...
public class DB_invoce_full_details
 
{
public ArrayList alErrors = new ArrayList();
public string connectionString;
public DB_invoce_full_details()
{
...
public int Add(invoce_full_details _tmpObject)
{
...
public int Update(invoce_full_details _tmpObject)
{
...
public int Delete(invoce_full_details _tmpObject)
{
...
public int Delete(invoce_full_details _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
SqlCommand command = new SqlCommand("DELETE FROM invoce_full_details  WHERE idRecInv=@idrecinv", conn);
if (tran != null)
{
command.Transaction = tran;
}
...
//GET BY ID ---------------------------------------------
////==========================================================================
public invoce_full_details GetById(int _id)
{
invoce_full_details tmpObject = new invoce_full_details();
 
  
 
SqlConnection conn = new SqlConnection(connectionString); 
SqlCommand command = new SqlCommand("Select * From invoce_full_details WHERE idRecInv=" + _id.ToString(), conn);
conn.Open();
...
//GET ALL ---------------------------------------------
////==========================================================================
public List<invoce_full_details> GetAll()
{
List<invoce_full_details> tmpList = new List<invoce_full_details>();
...
string msgRecField="-";
SqlConnection conn = new SqlConnection(connectionString); 
SqlCommand command = new SqlCommand("Select * From invoce_full_details", conn);
conn.Open();
SqlDataReader dr = command.ExecuteReader();
while (dr.Read())
{
...
//GET ALL by cond ---------------------------------------------
////==========================================================================
public List<invoce_full_details> GetAllByCond(string cond)
{
List<invoce_full_details> tmpList = new List<invoce_full_details>();
...
alErrors.Clear();
SqlConnection conn = new SqlConnection(connectionString); 
SqlCommand command = new SqlCommand("Select * From invoce_full_details Where "+cond, conn);
conn.Open();
SqlDataReader dr = command.ExecuteReader();
while (dr.Read())
{
