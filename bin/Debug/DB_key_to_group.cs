...
public class DB_key_to_group
 
{
public string connString;
public string connectionString;
public DB_key_to_group()
{
...
public int Add(key_to_group _tmpObject)
{
...
public int Add(key_to_group _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
...
public int Update(key_to_group _tmpObject)
{
...
public int Update(key_to_group _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
...
public int Delete(key_to_group _tmpObject)
{
...
public int Delete(key_to_group _tmpObject, SqlConnection conn, SqlTransaction tran)
{
int res = 0;
...
//GET BY ID ---------------------------------------------
////==========================================================================
public key_to_group GetById(int _id)
{
key_to_group tmpObject = new key_to_group();
