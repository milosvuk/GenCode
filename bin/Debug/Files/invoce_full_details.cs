...
public class invoce_full_details
 
{
public ArrayList alErrors = new ArrayList();
public string connectionString;
public invoce_full_details()
{
...
public invoce_full_details (System.Int32 _idrecinv,System.Int32 _idproperty,System.Int32 _idcustomer,System.DateTime _dateofinv,System.Int32 _idexpense,System.Decimal _amount,System.Decimal _taxperc,System.Decimal _taxamount,System.Decimal _totalamount,System.Decimal _amountpaid,System.Int32 _finalized,System.String _description,System.Int32 _active,System.Int32 _idcompany,System.String _customerfullname,System.String _codeofproperty,System.String _propertyname,System.String _expensedesc )
{
idrecinv=_idrecinv;
...
////==========================================================================
public bool Save(invoce_full_details _invoce_full_details)
{
bool tmp = false;
int res = -1;
_invoce_full_details.DELETED = 1;
...
try
{
DB_invoce_full_details db_invoce_full_details = new DB_invoce_full_details();
if (_invoce_full_details.IDINVOCE_FULL_DETAILS == 0)
{
res = db_invoce_full_details.Add(_invoce_full_details, conn, tran);
tran.Commit();
tmp = true;
}
else
{
res = db_invoce_full_details.Update(_invoce_full_details, conn, tran);
tran.Commit();
tmp = true;
}
}
...
{
int numberdelete=0;
string del = "DELETE FROM invoce_full_details WHERE idRecInv="+idrecinv.ToString();
...
string alistsearch = "SELECT * FROM invoce_full_details " +SearchExp;
ptl.DbaseSQLServer sq= new ptl.DbaseSQLServer();
sq.DbaseConnection = Con;
...
{
ArrayList alsearch = new ArrayList();
string alistsearch = "SELECT * FROM invoce_full_details";
ptl.DbaseSQLServer sq= new ptl.DbaseSQLServer();
sq.DbaseConnection = Con;
sq.SqlText = alistsearch;
alsearch = sq.RunViewSQL("|");
...
string dtsearch = "SELECT * FROM invoce_full_details " +SearchExp;
ptl.DbaseSQLServer sq= new ptl.DbaseSQLServer();
sq.DbaseConnection = Con;
sq.SqlText = dtsearch;
dt = sq.RunViewSQL();
...
{
DataTable dt = new DataTable();
string dtsearch = "SELECT * FROM invoce_full_details";
ptl.DbaseSQLServer sq= new ptl.DbaseSQLServer();
sq.DbaseConnection = Con;
sq.SqlText = dtsearch;
dt = sq.RunViewSQL();
