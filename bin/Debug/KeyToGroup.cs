...
public KeyToGroup (System.Int32 _id,System.Int32 _store_no,System.String _department,System.String _class_,System.String _vendor_code )
{
id=_id;
store_no=_store_no;
...
////==========================================================================
public bool Save(KeyToGroup _KeyToGroup)
{
bool tmp = false;
int res = -1;
_KeyToGroup.DELETED = 1;
...
try
{
DB_KeyToGroup db_KeyToGroup = new DB_KeyToGroup();
if (_KeyToGroup.IDKEYTOGROUP == 0)
{
res = db_KeyToGroup.Add(_KeyToGroup, conn, tran);
tran.Commit();
tmp = true;
}
else
{
res = db_KeyToGroup.Update(_KeyToGroup, conn, tran);
tran.Commit();
tmp = true;
}
}
