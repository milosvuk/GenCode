<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="childtableEdit.aspx.cs" Inherits="childtableEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="idchildtable"
...
<asp:BoundField DataField="idchildtable" HeaderText="idchildtable" />
<asp:BoundField DataField="id_maintable" HeaderText="id_maintable" />
