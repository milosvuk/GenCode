<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="costoflivingEdit.aspx.cs" Inherits="costoflivingEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="idRecCostOfLiving"
...
<asp:BoundField DataField="idRecCostOfLiving" HeaderText="idRecCostOfLiving" />
<asp:BoundField DataField="IncreaseInPerc" HeaderText="IncreaseInPerc" />
