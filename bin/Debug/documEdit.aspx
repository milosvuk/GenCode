<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="documEdit.aspx.cs" Inherits="documEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="iddocument"
...
<asp:BoundField DataField="iddocument" HeaderText="iddocument" />
<asp:BoundField DataField="codeofdocument" HeaderText="codeofdocument" />
<asp:BoundField DataField="nameofdocuments" HeaderText="nameofdocuments" />
