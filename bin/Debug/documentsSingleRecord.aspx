<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="documentsSingleRecord.aspx.cs" Inherits="documentsSingleRecord" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
<table style="width: 100%;">
<tr>
<td>
<asp:Label ID="lbliddocuments" runat="server" Text="iddocuments"></asp:Label>
</td>
<td>
<asp:TextBox ID="txtiddocuments" runat="server"></asp:TextBox>
</td>
</tr>
<tr>
<td>
