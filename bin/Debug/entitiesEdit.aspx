<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="entitiesEdit.aspx.cs" Inherits="entitiesEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="identities"
...
<asp:BoundField DataField="identities" HeaderText="identities" />
<asp:BoundField DataField="name" HeaderText="name" />
<asp:BoundField DataField="description" HeaderText="description" />
<asp:BoundField DataField="active" HeaderText="active" />
<asp:BoundField DataField="id_comany" HeaderText="id_comany" />
    </Columns>
