<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="linkinfoprocessEdit.aspx.cs" Inherits="linkinfoprocessEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="idprojectprocessinfo"
...
<asp:BoundField DataField="idprojectprocessinfo" HeaderText="idprojectprocessinfo" />
<asp:BoundField DataField="NameOfInformation" HeaderText="NameOfInformation" />
<asp:BoundField DataField="NameOfProcess" HeaderText="NameOfProcess" />
