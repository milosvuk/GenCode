<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="linkprocessentitiesEdit.aspx.cs" Inherits="linkprocessentitiesEdit" %>
...
AutoGenerateColumns="False" DataKeyNames="idprojectprocessentities"
...
<asp:BoundField DataField="idprojectprocessentities" HeaderText="idprojectprocessentities" />
...
<asp:BoundField DataField="id_identities" HeaderText="id_identities" />
    </Columns>
