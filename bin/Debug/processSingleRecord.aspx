<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="processSingleRecord.aspx.cs" Inherits="processSingleRecord" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
<table style="width: 100%;">
<tr>
<td>
<asp:Label ID="lblidprocess" runat="server" Text="idprocess"></asp:Label>
</td>
<td>
<asp:TextBox ID="txtidprocess" runat="server"></asp:TextBox>
</td>
</tr>
<tr>
<td>
