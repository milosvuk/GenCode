...
public partial class projectEdit : System.Web.UI.Page
{
              ...
              private void set_grid()
               {
                    ...
                    this.GridView1.DataSource = listproject;
                    this.GridView1.DataBind();
                    this.ListBox1.DataSource = listproject;
                    this.ListBox1.DataTextField = "idproject";
                    this.ListBox1.DataValueField = "idproject";
    ...
    protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session["idproject"] = idRecord;  // IT HAS TO CLASSNAME sesssion variable created in Global.aspx
        Session["Loggedin"] = Label2.Text;
        Response.Redirect("projectSingleRecord.aspx");  //change to real single page
    }
