...
public partial class servicesEdit : System.Web.UI.Page
{
              ...
              private void set_grid()
               {
                    ...
                    this.GridView1.DataSource = listservices;
                    this.GridView1.DataBind();
                    this.ListBox1.DataSource = listservices;
                    this.ListBox1.DataTextField = "idservices";
                    this.ListBox1.DataValueField = "idservices";
    ...
    protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Session["idservices"] = idRecord;  // IT HAS TO CLASSNAME sesssion variable created in Global.aspx
        Session["Loggedin"] = Label2.Text;
        Response.Redirect("servicesSingleRecord.aspx");  //change to real single page
    }
